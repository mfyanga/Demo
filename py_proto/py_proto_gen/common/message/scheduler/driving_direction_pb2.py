...
# source: common/message/scheduler/driving_direction.proto
...
DrivingDirectionProto = _reflection.GeneratedProtocolMessageType('DrivingDirectionProto', (_message.Message,), dict(
  ...
  __module__ = 'common.message.scheduler.driving_direction_pb2'
