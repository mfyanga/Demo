...
# source: message/scheduler/door_control.proto
...
DoorControlCmd = _reflection.GeneratedProtocolMessageType('DoorControlCmd', (_message.Message,), dict(
  ...
  __module__ = 'message.scheduler.door_control_pb2'
